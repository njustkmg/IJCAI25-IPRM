...
def load_split_nvgesture(file_with_split, new_path):
    list_split = list()
...
def load_of_data(index, mode, x, y, start_frame, random_seed, new_path):
...
class nvGesture_dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        of = load_of_data(idx, self.mode, x, y, start_frame, random_seed, new_path=self.video_root)
